  ...
  return (
    <div className="jobs-page">
      ...
      <div className="category-buttons">
        <button onClick={() => categoryHandler(null)} className={selectedCategory === null ? "active" : ""}>
          All
        </button>
        <button onClick={() => categoryHandler("Frontend")} className={selectedCategory === "Frontend" ? "active" : ""}>
          Frontend
        </button>
        <button onClick={() => categoryHandler("Backend")} className={selectedCategory === "Backend" ? "active" : ""}>
          Backend
        </button>
        <button
      ...
      <JobList filter={inputText} category={selectedCategory} />
    </div>
  );
};
